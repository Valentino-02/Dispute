  ...
  return (
    <>
      ...
      >
        ...
        <kbd className=" text-xs pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border bg-dark-blue text-main-yellow px-1.5 font-mono text-[10px] font-medium ml-auto">
          ctrl S
        </kbd>
      </button>
